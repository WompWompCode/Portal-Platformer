...
Player, Terrain, Portal = assets.platformerAssets(win)
...
Portals.append(portalOne)
Portals.append(portalTwo)
...
while run:
    ...
    if windowScrollMovement < 200:
        ...
        portalOne.XPlaced -= windowScrollMovement
        portalTwo.XPlaced -= windowScrollMovement
